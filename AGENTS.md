...
- Backend: Express + Postgres (Render).
...
- Items table has Status/Stock/Needed logic; other tables use custom columns.
...
## Sections & Columns
- Items: Item, Status, Stock, Needed, Delete (+ Edit on left).
